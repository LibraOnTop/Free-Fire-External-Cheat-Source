...
bool ImGui::ButtonEx(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags)
{
    ...
    it_anim->second.b = ImLerp(it_anim->second.b, hovered ? ImColor(47, 108, 153, 200).Value : ImColor(ImGui::GetColorU32(ImGuiCol_Border)).Value, g.IO.DeltaTime * 10.f);
...
bool ImGui::Tab(const char* Label, const char* Icon, bool Enabled)
{
    ...
    if (Enabled)
    {
        window->DrawList->AddRectFilled(total_bb.Min, total_bb.Max, ImColor(47, 108, 153, (int)(ImGui::GetStyle().Alpha * 255)), 5);
...
bool ImGui::TabHeaderButton(const char* ButtonName, bool enabled, int direction, int TabIndex)
{
    ...
    ImColor BGColor = enabled ? ImColor(47, 108, 153, (int)(GetStyle().Alpha * 255)) : ImColor(16, 16, 16, (int)(GetStyle().Alpha * 255));
    ...
    if (enabled)
        window->DrawList->AddRectFilled(ImVec2(window->Pos.x + Value->second.posx + 1, bb.Min.y + 1), ImVec2(window->Pos.x + Value->second.posx + size.x - 1, bb.Max.y - 1), ImColor(47, 108, 153, (int)(GetStyle().Alpha * 255)), 5, Corner);
...
bool ImGui::ScrollbarEx(const ImRect& bb_frame, ImGuiID id, ImGuiAxis axis, ImS64* p_scroll_v, ImS64 size_avail_v, ImS64 size_contents_v, ImDrawFlags flags)
{
    ...
    if (axis == ImGuiAxis_Y)
        window->DrawList->AddRectFilledMultiColor(grab_rect.Min, grab_rect.Max, ImColor(47, 108, 153, 0), ImColor(47, 108, 153, 0), ImColor(47, 108, 153, (int)(GetStyle().Alpha * 255)), ImColor(47, 108, 153, (int)(GetStyle().Alpha * 255)), 5);
...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    if (std::abs(Value->second.a) < 0.9f)
        window->DrawList->AddRectFilled(check_bb.Min + ImVec2(check_bb.GetWidth() / 2 * Value->second.a + 1, check_bb.GetHeight() / 2 * Value->second.a + 1), check_bb.Max - ImVec2(check_bb.GetWidth() / 2 * Value->second.a + 1, check_bb.GetHeight() / 2 * Value->second.a + 1), ImColor(47, 108, 153, (int)(GetStyle().Alpha * 255)), 5);
...
bool ImGui::CheckboxRisk(const char* label, bool* v)
{
    ...
    if (std::abs(Value->second.a) < 0.9f)
        window->DrawList->AddRectFilled(
            ...
            ImColor(47, 108, 153, (int)(GetStyle().Alpha * 255)), 5);
...
bool ImGui::BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags, int itemcount)
{
    ...
    if (!(flags & ImGuiComboFlags_NoPreview))
    {
        ...
        window->DrawList->AddCircleFilled(ImVec2(bb.Max.x - 14, bb.Min.y + total_bb.GetHeight() / 2), Value->second.a, ImColor(47, 108, 153, (int)(GetStyle().Alpha * 255)), 360);
    }
...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags)
{
    ...
    if (grab_bb.Max.x > grab_bb.Min.x)
        window->DrawList->AddRectFilled(frame_bb.Min + ImVec2(1, 0), ImVec2(frame_bb.Min.x + Value->second.anim + 1, frame_bb.Max.y), ImColor(47, 108, 153, (int)(GetStyle().Alpha * 255)), 5);
...
bool ImGui::InputTextEx(const char* label, const char* hint, char* buf, int buf_size, const ImVec2& size_arg, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback, void* callback_user_data)
{
    ...
    it_anim->second.border = ImLerp(it_anim->second.border, IsItemActive() || hovered ? ImColor(47, 108, 153, 255) : ImColor(30, 30, 30), g.IO.DeltaTime * 3.f);
